...
// Try to connect to MongoDB, fallback to memory store if connection fails
let sessionStore;
try {
    ...
    console.warn('MongoDB connection failed, using memory store for sessions:', err.message);
